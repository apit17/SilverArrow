...
//                activityIndicator.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhite;
                [activityIndicator setColor:[UIColor colorWithHexString:@"FFD203"]];
...
- (void) initializePageControl
{
    ...
    if(_pageIndicatorActiveColor==nil){
        _pageIndicatorActiveColor = [UIColor colorWithHexString:@"FFD203"];
    }
    
    _pageControl.currentPageIndicatorTintColor = _pageIndicatorActiveColor;
